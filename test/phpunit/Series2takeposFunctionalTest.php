...
/**
 * \file    test/functional/Series2takeposFunctionalTest.php
...
/**
 * Class Series2takeposFunctionalTest
 *
 ...
 *
 * @package Testseries2takepos
 */
class Series2takeposFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modSeries2takepos')->click();
		} else {
			// Disable the module
			$this->byHref('modSeries2takepos')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/series2takepos/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('series2takepos/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/series2takepos/admin/about.php');
		$this->authenticate();
		return $this->assertContains('series2takepos/admin/about.php', $this->url(), 'About page');
	}
...
return $this->assertEquals(
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('series2takeposwidget1', $this->source(), "Box enabled");
	}
...
return $this->assertContains(
			'interface_99_modSeries2takepos_Series2takeposTriggers.class.php',
...
return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSeries2takepos_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
